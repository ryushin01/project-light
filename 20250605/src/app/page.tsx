...
const pathSpy = () => {
  ...
  const putPath = storage.getItem("currentPath");

  if (!storage) {
    return;
  }

  localStorage.setItem("putPath", putPath!);
};
      ...
      >
        ...
        <section
          ...
          onClick={() => {
            ...
            window.flutter_inappwebview.callHandler("flutterFunc", {
              action: "openPdf",
              url: "https://bankle.notion.site/2005a9ad1c9a8015a1d8e715150463ab", // notion 주소
              // url: "https://www.kosapp.co.kr/assets/files/menual.pdf", // PDF 주소
            });
          }}
        >
          <h2 className="sr-only">배너 영역</h2>
          <span className="block w-full h-[100px] relative overflow-hidden cursor-pointer">
